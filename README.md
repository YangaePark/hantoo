...
시놀로지에서는 공개 GitHub 저장소를 Docker build context로 바로 사용하는 Container Manager 프로젝트 배포를 권장합니다. NAS에 소스 코드를 따로 클론하지 않아도 Container Manager가 GitHub에서 코드를 받아 이미지를 빌드합니다.
